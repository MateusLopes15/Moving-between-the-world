...
public class ChecarEstado2 : MonoBehaviour
{
    ...
    MoveObject2D3[] objetos;

    void Start()
    {
        cronometro = 0;
        completou = false;
        objetos = FindObjectsOfType<MoveObject2D3>();
    }
    ...
    void Update()
    {
        ...
        { //5Hz
            ...
            if (soma >= objetos.Length)
            {
                ...
                Destroy(GetComponent<ChecarEstado2>());
                Destroy(GetComponent<TriggerCube2>());
